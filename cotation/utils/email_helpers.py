...
def queue_admin_notification_email(demande):
    ...
    for admin_email in admin_emails:
        email_queue = EmailQueue.objects.create(
            ...
            to_email='sourcing@oils-of-africa.com',
            cc_emails=','.join(getattr(settings, 'ADMIN_CC_EMAILS', ['kaboremessi@gmail.com','serge.debetou@oils-of-africa.com','liberia.office@oils-of-africa.com'])),
