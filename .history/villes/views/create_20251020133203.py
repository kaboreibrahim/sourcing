...
class VilleCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # CORRECTION: Les coordonnées de San-Pédro étaient inversées
        context['port_sanpedro'] = {
            'lat': 4.739742,  # Latitude (Nord-Sud)
            'lon': -6.619978,  # Longitude (Est-Ouest) - doit être négatif pour l'Ouest
