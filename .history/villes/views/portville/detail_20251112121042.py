...
class VillePortDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        print("longitude du port:", port.longitude, "latitude du port:", port.latitude)
        ville = ville_port.ville
        print("longitude de la ville:", ville.longitude, "latitude de la ville:", ville.latitude)
        ...
        print("longitude du port:", port.longitude, "latitude du port:", port.latitude)
        print("longitude de la ville:", ville.longitude, "latitude de la ville:", ville.latitude)
        print("la distance",ville_port.distance)
