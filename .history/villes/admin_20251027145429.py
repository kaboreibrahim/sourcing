...
from .models import Ville, Localite
...
class LocaliteInline(admin.TabularInline):
    ...
    model = Localite
    extra = 0
    fields = ('nom', 'distance_port_abidjan', 'distance_port_sanpedro', 'created_at', 'updated_at')
