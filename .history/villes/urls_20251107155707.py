...
from localite.views import (VilleListView, VilleCreateView, VilleDetailView, 
VilleUpdateView, VilleDeleteView ,localiteCreateView, LocaliteListView, 
LocaliteDeleteView, LocaliteUpdateView, LocaliteDetailView)

from ville.views import (VilleListView, VilleCreateView, VilleDetailView, 
VilleUpdateView, VilleDeleteView)

from portville.views import (VillePortListView)
