...
class FournisseurVille(SafeDeleteModel):
    """
    Modèle de liaison entre un Fournisseur et une Ville.
    ...
    distance=models.DecimalField(
        ...
        blank=True,
        null=True,
        help_text="Distance entre le fournisseur et la ville"
    )
    ...
    class Meta:
        db_table = 'fournisseur_ville'
        verbose_name = _("Lien Fournisseur-Ville")
        verbose_name_plural = _("Liens Fournisseur-Villes")
        unique_together = [['fournisseur', 'ville']]
        indexes = [
    ...
    def __str__(self):
        return f"{self.fournisseur.nom} - {self.ville.nom}"
...
class FournisseurLocalite(SafeDeleteModel):
    """
    Modèle de liaison entre un Fournisseur et une Localite.
    Permet de gérer plusieurs fournisseurs pour une même commodité.
    """
    _safedelete_policy = SOFT_DELETE_CASCADE
    ...
    class Meta:
        db_table = 'fournisseur_localite'
        verbose_name = _("Lien Fournisseur-Localite")
        verbose_name_plural = _("Liens Fournisseur-Localites")
        unique_together = [['fournisseur', 'localite']]
        indexes = [
            models.Index(fields=['fournisseur']),
    ...
    def __str__(self):
        return f"{self.fournisseur.nom} - {self.localite.nom}"
