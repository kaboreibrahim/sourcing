...
class VilleAdmin(SimpleHistoryAdmin):
    ...
    inlines = [LocaliteInline,VillePortInline]
    list_per_page = 25
...
@admin.register(VillePort)
class VillePortAdmin(SimpleHistoryAdmin):
    list_display = [
        'ville',
        'port',
        'distance',
    ...
    list_filter = ['ville', 'port', 'created_at', 'updated_at']
    search_fields = ['ville__nom', 'port__nom']
    readonly_fields = ['id', 'created_at', 'updated_at']
    autocomplete_fields = ['ville', 'port']
    list_per_page = 25

@admin.register(PortLocalite)
class PortLocaliteAdmin(SimpleHistoryAdmin):
    list_display = [
        'port',
        'localite',
        'distance',
    ...
    list_filter = ['port', 'localite', 'created_at', 'updated_at']
    search_fields = ['port__nom', 'localite__nom']
    readonly_fields = ['id', 'created_at', 'updated_at']
    autocomplete_fields = ['port', 'localite']
    list_per_page = 25
