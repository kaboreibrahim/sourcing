...
from .views import (VilleListView, VilleCreateView, VilleDetailView, VilleUpdateView, VilleDeleteView ,localiteCreateView, LocaliteListView, LocaliteDeleteView, LocaliteUpdateView)
