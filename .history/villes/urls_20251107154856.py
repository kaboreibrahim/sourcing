...
LocaliteDeleteView, LocaliteUpdateView, LocaliteDetailView, VillePortListView)
...
urlpatterns = [
   # URLs pour les Villes
    ...
    # path('port-ville/<uuid:pk>/update/', VillePortUpdateView.as_view(), name='ville-port-update'),
    # path('port-ville/<uuid:pk>/delete/', VillePortDeleteView.as_view(), name='ville-port-delete'),
