...
urlpatterns = [
   # URLs pour les Villes
    ...
    path('villes/<uuid:uuid>/', VilleDetailView.as_view(), name='ville-detail'),
    path('villes/<uuid:uuid>/update/', VilleUpdateView.as_view(), name='ville-update'),
    path('villes/<uuid:uuid>/delete/', VilleDeleteView.as_view(), name='ville-delete'),
