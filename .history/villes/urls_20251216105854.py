...
PortLocaliteListView, LoadPortsByPaysLocaliteView,PortLocaliteCreateView,PortLocaliteDetailView,ZoneListAPI,LocaliteVilleListAPI
)
...
urlpatterns = [
   # URLs pour les Villes
    ...
    path('api/villes/', LocaliteVilleListAPI.as_view(), name='api_villes'),
