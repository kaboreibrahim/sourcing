...
from localite.views import localiteCreateView, LocaliteListView, LocaliteDeleteView, LocaliteUpdateView, LocaliteDetailView

from ville.views import VilleListView, VilleCreateView, VilleDetailView, VilleUpdateView, VilleDeleteView
