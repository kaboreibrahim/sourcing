...
class Fournisseur(SafeDeleteModel):
    ...
    - `nom_responsable`: Nom du responsable du fç"ournisseur.
...
class FournisseurPort(SafeDeleteModel):
    ...
    def calculate_distance(self):
        ...
        if not all([self.port.latitude, self.port.longitude, 
                   self.fournisseur.latitude, self.fournisseur.longitude]):
            return None
        ...
        destination = f"{self.fournisseur.longitude},{self.fournisseur.latitude}"
