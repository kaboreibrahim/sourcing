...
urlpatterns = [
    ...
    path('api/zones/', FournisseurZoneListAPI.as_view(), name='fournisseur_api_zones'),
    path('api/villes/', FournisseurVilleListAPI.as_view(), name='fournisseur_api_villes'),

    path('fournisseurs/ports/<uuid:pk>/',PortFournisseurDetailView.as_view(),name='port-fournisseur-detail'),
