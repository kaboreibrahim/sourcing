...
urlpatterns = [
    ...
    path('fournisseurs/<uuid:fournisseur_id>/ports/add/',PortFournisseurCreateView.as_view(),name='fournisseur-port-add'),
    path('',PortFournissuerListView.as_view(),name='port-fournisseur-list'),
]