...
class FournisseurListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        # Filtre de recherche
        # Dans get_queryset, modifiez la partie recherche comme ceci :
        ...
        if search_query:
            queryset = queryset.filter(
                ...
                Q(localite__nom__icontains=search_query) |  # Accès au nom de la localité
                Q(ville__nom__icontains=search_query) |      # Accès au nom de la ville
                Q(ville__zone__nom__icontains=search_query)  # Accès au nom de la zone via la ville
            )
