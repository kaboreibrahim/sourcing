...
from utilisateur.views import (connexion, two_factor_method, email_verification,
                                ...
                                AccueilFournisseurView, DetailCommoditeFournisseurView,
                                UpdateDisponibiliteCommoditeView)
...
urlpatterns = [
    ...
    path('fournisseurs/commodite/<uuid:pk>/disponibilite/', UpdateDisponibiliteCommoditeView.as_view(), name='update_disponibilite'),
 ]
