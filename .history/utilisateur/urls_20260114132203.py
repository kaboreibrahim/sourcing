...
from utilisateur.views import (connexion,register,two_factor_method,email_verification
                                ,google_auth_verification,fournisseurs_map,user_logout,forgatpassword_with_token)
...
urlpatterns = [
    ...
    #path('forgatpassword/', forgatpassword, name='forgatpassword'),
    path('forgatpassword/', forgatpassword_with_token, name='forgatpassword_with_token'),
