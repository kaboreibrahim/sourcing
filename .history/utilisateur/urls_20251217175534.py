...
from utilisateur.views import (connexion,two_factor_method,email_verification
                                ,google_auth_verification,fournisseurs_map,user_logout,AccueilFournisseurView)
...
urlpatterns = [
    ...
    path('utilisateur/api/fournisseurs/', FournisseursAPIView.as_view(), name='api_fournisseurs'),
