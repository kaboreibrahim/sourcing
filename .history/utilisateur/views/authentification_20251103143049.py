        ...
        if form.is_valid():
            ...
            if method == 'email':
                ...
                send_mail(
                    ...
                    Nous vous avons envoyé ce message pour vous fournir votre code de vérification à deux facteurs pour votre compte Sourcing.
                    ...
                    Merci de faire confiance au sourcing.

                    Cordialement,
                    L'équipe Sourcing
                    ''',
                    'no-reply@sourcing.com',
                    [user.email],
                    fail_silently=False,
                )
