...
from django.db.models import Prefetch, Sum, Count  # Ajout de Count
...
class AccueilFournisseurView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        return (
            ...
            .annotate(
                quantite_totale=Sum('liens_fournisseurs__quantite_disponible'),
                prix_moyen=Sum('liens_fournisseurs__prix_unitaire') / Count('liens_fournisseurs')
            )
            .distinct()
        )