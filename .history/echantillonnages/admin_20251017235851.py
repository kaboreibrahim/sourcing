...
class EchantionnageAdmin(SimpleHistoryAdmin):
    ...
    list_filter = [
        'fournisseur_commodite__fournisseur',
        'utilisateur',
        'date_creation',
        'created_at',
        'updated_at',
    ...
    search_fields = [
        'reference',
        'fournisseur_commodite__commodite__nom',
        'fournisseur_commodite__fournisseur__nom',
    ...
    autocomplete_fields = ['fournisseur_commodite', 'utilisateur']
    ...
    fieldsets = (
        ...
        (_('Informations géographiques'), {
            'fields': ('commodite_info', 'fournisseur_info', 'ville_info', 'zone_info'),
            'classes': ('collapse',)
        }),
    ...
    def get_queryset(self, request):
        ...
        return qs.select_related(
            'fournisseur_commodite',
            'fournisseur_commodite__commodite',
            'fournisseur_commodite__fournisseur',
            'fournisseur_commodite__fournisseur__ville',
            'fournisseur_commodite__fournisseur__ville__zone',
            'utilisateur'
        )
