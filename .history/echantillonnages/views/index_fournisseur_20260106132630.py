            ...
            .annotate(
                quantite_totale=Coalesce(
                    Sum('liens_fournisseurs__quantite_disponible', 
                        filter=F('liens_fournisseurs__quantite_disponible__isnull') | 
                               ~F('liens_fournisseurs__quantite_disponible'),
                ...
                prix_moyen=Coalesce(
                    Avg('liens_fournisseurs__prix_unitaire',
                        filter=F('liens_fournisseurs__prix_unitaire__isnull') | 
                               ~F('liens_fournisseurs__prix_unitaire'),
                        output_field=FloatField()
                    ),
                    Value(0.0, output_field=FloatField())
                ),
