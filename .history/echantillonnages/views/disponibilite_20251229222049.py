...
class ListeDisponibilitesView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for commodite in commodites:
            ...
            fournisseurs_data = []
            fournisseurs_vus = set()
            
            for echantillon in echantillons_commodite.order_by('-date_creation'):
                if echantillon.fournisseur_id not in fournisseurs_vus:
                    ...
                    fournisseurs_vus.add(echantillon.fournisseur_id)
            ...
            if fournisseurs_data:  # Ne pas inclure les commodités sans fournisseurs
                disponibilites.append({
                    ...
                    'fournisseurs': sorted(
                        ...
                        reverse=True
                    )[:3]  # Prendre les 3 plus gros fournisseurs
                })
