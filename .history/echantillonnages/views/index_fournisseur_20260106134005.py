            ...
            .annotate(
                quantite_totale=Coalesce(
                    Sum('liens_fournisseurs__quantite_disponible', 
                        filter=Q(liens_fournisseurs__quantite_disponible__isnull=True) | 
                               Q(liens_fournisseurs__quantite_disponible__isnull=False),
                ...
                prix_moyen=Coalesce(
                    Avg('liens_fournisseurs__prix_unitaire',
                        filter=Q(liens_fournisseurs__prix_unitaire__isnull=True) | 
                               Q(liens_fournisseurs__prix_unitaire__isnull=False),
                        output_field=FloatField()
                    ),
                    Value(0.0, output_field=FloatField())
                ),
