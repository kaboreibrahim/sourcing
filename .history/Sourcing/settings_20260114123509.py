...
ALLOWED_HOSTS = [
    "127.0.0.1",
    "localhost",
    "rrxg1wgo0qfw.share.zrok.io",  # ton domaine zrok
]
...
# Dossiers où Django va chercher les fichiers statiques en développement
STATICFILES_DIRS = [
...
# URL à utiliser pour les fichiers statiques en production
STATIC_URL = '/static/'
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "https://rrxg1wgo0qfw.share.zrok.io",  # l'URL publique générée par zrok
]
