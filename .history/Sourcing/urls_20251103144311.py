...
handler404 = 'utilisateur.views.error.custom_page_not_found'
handler403 = 'utilisateur.views.error.custom_permission_denied'
handler500 = 'utilisateur.views.error.custom_server_error'
handler400 = 'utilisateur.views.error.custom_bad_request'
